<?php
	...
	$pagina = array(
		...
		"url" 			=> config::getAbsPath('/pregrado'),
		"type" 			=> "place",
		"title" 		=> "UNPRG | Pregrado",
		"description" 	=> "Pregrado de la Universidad Nacional Pedro Ruiz Gallo",
		"image" 		=> "/frontend/img/info/pregrado.jpg"
	);
	...
	<section class="block infpg">
		...
		<div class="infpg__cover plx">
			<div class="infpg__cover__img">
				<img src="/frontend/img/info/pregrado.jpg" alt="Portada Admisión">
			</div>
