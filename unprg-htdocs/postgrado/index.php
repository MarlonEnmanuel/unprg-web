<?php
	...
	$pagina = array(
		...
		"url" 			=> config::getAbsPath('/postgrado'),
		"type" 			=> "place",
		"title" 		=> "UNPRG | Postgrado",
		"description" 	=> "Postgrado de la Universidad Nacional Pedro Ruiz Gallo",
		"image" 		=> "/frontend/img/info/postgrado.jpg"
	);
