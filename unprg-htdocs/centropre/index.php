<?php
	...
	$pagina = array(
		...
		"url" 			=> config::getAbsPath('/centropre'),
		"type" 			=> "place",
		"title" 		=> "UNPRG | Centro Pre",
		"description" 	=> "Centro Pre Francisco Aguinaga Castro",
		"image" 		=> "/frontend/img/info/centropre.jpg"
	);
...
<body>
	...
	<section class="block infpg">
		...
		<div class="infpg__cover plx">
			<img class="infpg__cover__img" src="/frontend/img/info/centropre.jpg" alt="Portada Centro Pre">
			<div class="infpg__cover__texto ff--44 ff--condensed ff--special">
				<div class="block__wraper--slim plx__item slow">
					Centro Pre Franciso Aguinaga Castro
				</div>
			</div>
		</div>
