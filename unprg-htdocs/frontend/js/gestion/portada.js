sgw.Views.Enlaces = Backbone.View.extend({
	tagName 	: $('#template_portadas').attr('data-tag'),
	className 	: $('#template_portadas').attr('data-class'),
	template 	: _.template($('#template_portadas').html()),
	events : {
...
sgw.Views.Enlace = Backbone.View.extend({
	tagName 	: $('#template_portada').attr('data-tag'),
	className 	: $('#template_portada').attr('data-class'),
...
sgw.Views.OtroEnlace = Backbone.View.extend({
	tagName 	: $('#template_portada_otro').attr('data-tag'),
	className 	: $('#template_portada_otro').attr('data-class'),
	template 	: _.template($('#template_portada_otro').html()),
	render : function(){
		this.$el.html(this.template(this.model.toJSON()));
		return this.$el;
	}
