sgw.Views.Enlaces = Backbone.View.extend({
	tagName 	: $('#template_avisos').attr('data-tag'),
	className 	: $('#template_avisos').attr('data-class'),
	template 	: _.template($('#template_avisos').html()),
	events : {
...
sgw.Views.OtroEnlace = Backbone.View.extend({
	tagName 	: $('#template_aviso_otro').attr('data-tag'),
	className 	: $('#template_aviso_otro').attr('data-class'),
	template 	: _.template($('#template_aviso_otro').html()),
	render : function(){
		this.$el.html(this.template(this.model.toJSON()));
		return this.$el;
	}
